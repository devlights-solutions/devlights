...
/**
* Kunena Component
* @package Kunena.Template.ASTemplate
*
* @copyright Copyright (C) 2012 - 2013 Jetimpex, Inc.
* @license http://www.gnu.org/licenses/gpl-2.0.html GNU/GPLv2 
* @link http://www.asdesigning.com
**/

defined( '_JEXEC' ) or die();

class KunenaTemplateASTemplate extends KunenaTemplate {
	// Try to find missing files from the following parent templates:
	protected $default = array('astemplate');
	...
	public function initialize() {
		KunenaFactory::loadLanguage('com_kunena.tpl_astemplate');

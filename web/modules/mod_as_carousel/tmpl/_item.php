...
<figure class="item_img img-intro img-intro__<?php echo htmlspecialchars($params->get('intro_image_align')); ?>"> 
	<?php if ((($params->get('link_titles')) || $params->get('readmore')) && $item->readmore) : ?>
	...
	<?php endif; ?>
		...
		<?php endif;
	if ((($params->get('link_titles')) || $params->get('readmore')) && $item->readmore) : ?>
	</a>
	<?php endif; ?>
</figure>
<?php endif;
...
if($params->get('intro_text'))
{
	echo '<div class="text-separator"> </div>';
	echo $item->introtext; 
}
